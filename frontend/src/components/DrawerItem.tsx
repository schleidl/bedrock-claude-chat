  ...
  return (
    <Link
      className={twMerge(
        ...
        props.isActive ?? true
          ? 'bg-aws-orange-light dark:bg-aws-orange-light'
          : 'hover:bg-aws-sea-blue-light/20 dark:hover:bg-aws-sea-blue-light/20',
        props.className
      )}
      to={props.to}
          ...
          {(props.isBlur ?? true) && (
            <div
              className={twMerge(
                ...
                props.isActive
                  ? 'from-aws-orange-light dark:from-aws-orange-light'
                  : 'from-aws-squid-ink-light dark:from-aws-squid-ink-light group-hover:from-aws-sea-blue-light/20 dark:group-hover:from-aws-sea-blue-light/20'
              )}
            />
          )}
        </div>
