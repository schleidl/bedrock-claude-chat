  ...
  return (
    <div className="relative flex h-dvh w-screen bg-aws-paper-light dark:bg-aws-paper-dark">
      ...
      <main className="min-h-dvh relative flex flex-col flex-1 overflow-y-hidden transition-width">
        ...
        <header className="visible flex h-14 w-full items-center bg-aws-squid-ink-light dark:bg-aws-squid-ink-dark p-3 text-lg text-aws-font-color-white-light dark:text-aws-font-color-white-dark lg:hidden lg:h-0">
          <button
